all: receive_implicit receive_explicit transmit_implicit transmit_explicit ping pong lora_communication

LoRa.o: LoRa_rpi.c
	gcc -c LoRa_rpi.c -o LoRa.o -lpigpio -lrt -pthread -lm

lora_communication: LoRa.o lora_communication.o
	gcc -o lora_communication lora_communication.c LoRa_rpi.c LoRa_rpi.h -lpigpio -lrt -pthread -lm
