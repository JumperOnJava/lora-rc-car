...
lora_communication_server: 
	g++ -o lora_communication_server mongoose.h mongoose.c LoRa.c lora_communication_server.cpp -lpigpio -lrt -pthread -lm

wsl_lora_communication_server: 
	g++ -o wsl_lora_communication_server mongoose.h mongoose.c lora_communication_server.cpp -lrt -pthread -lm
